    ...
    <div className="min-h-screen bg-cream">
      ...
      <div className="px-4 py-6 space-y-6 animate-fade-in">
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm text-center">
          ...
          <p className="text-lg font-bold text-ink">#{order.id}</p>
        </div>
        ...
        {(order.status === 'out-for-delivery' || order.status === 'shipped') && (
          <div className="bg-white rounded-xl shadow-sm overflow-hidden">
            <div className="aspect-video bg-blush flex flex-col items-center justify-center gap-2">
        ...
        <a href="https://wa.me/96599991234" target="_blank" rel="noopener noreferrer">
          <Button
            variant="outline"
            className="w-full border-plum text-plum hover:bg-plum hover:text-white rounded-full py-6 text-base font-medium"
          >
